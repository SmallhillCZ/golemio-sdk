...
**priority** | **string** | Installation or maintenance priority assigned to this panel (\&quot;p1\&quot; to \&quot;p5\&quot;). May be null. | [optional] [default to undefined]
...
**handed_over_to_ozp** | **boolean** | Whether this panel has been formally handed over to OZP (Odbor životního prostředí) for management. May be null. | [optional] [default to undefined]
...
**cleaning_frequency** | **string** | Scheduled cleaning frequency for this panel. Free-text field. May be null. | [optional] [default to undefined]
...
**construction_type** | **string** | Construction type of the panel (e.g. \&quot;Samostatně stojící\&quot;, \&quot;V přístřešku\&quot;, \&quot;V označníku\&quot;, \&quot;Na konstrukci - VO\&quot;, \&quot;Ostatní\&quot;). May be null. | [optional] [default to undefined]
**panel_size** | **number** | Number of rows the information panel can display. May be null. | [optional] [default to undefined]
...
```typescript
import { InformationPanel } from 'golemio-public-transport-api';

const instance: InformationPanel = {
    id,
    source_created_at,
    source_updated_at,
    source_published_at,
