...
export class SDK {
    GTFSRealtimeV2Api: GTFSRealtimeV2Api;
    GTFSStaticV2Api: GTFSStaticV2Api;
    PIDDepartureBoardsV2Api: PIDDepartureBoardsV2Api;
    PIDDepartureBoardsV3Api: PIDDepartureBoardsV3Api;
    PIDRealtimePositionsV2Api: PIDRealtimePositionsV2Api;
    PublicDeparturesV2Api: PublicDeparturesV2Api;
    PublicGTFSStaticLookupV2Api: PublicGTFSStaticLookupV2Api;
    PublicVehiclePositionsV2Api: PublicVehiclePositionsV2Api;
    ...
    constructor(configurationParams: ConfigurationParameters & { basePath: string }, axios?: AxiosInstance) {
        ...
        this.GTFSRealtimeV2Api = new GTFSRealtimeV2Api(configuration, axios!);
        this.GTFSStaticV2Api = new GTFSStaticV2Api(configuration, axios!);
        this.PIDDepartureBoardsV2Api = new PIDDepartureBoardsV2Api(configuration, axios!);
        this.PIDDepartureBoardsV3Api = new PIDDepartureBoardsV3Api(configuration, axios!);
        this.PIDRealtimePositionsV2Api = new PIDRealtimePositionsV2Api(configuration, axios!);
        this.PublicDeparturesV2Api = new PublicDeparturesV2Api(configuration, axios!);
        this.PublicGTFSStaticLookupV2Api = new PublicGTFSStaticLookupV2Api(configuration, axios!);
        this.PublicVehiclePositionsV2Api = new PublicVehiclePositionsV2Api(configuration, axios!);
    };
}